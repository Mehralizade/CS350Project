...
public class CalculatorTest {
    ...
    public void calculateBi() {
        Double number = 9.00;
        Double number2 = 9.00;
        Calculator calculator = new Calculator(number,number2);
        ...
        Assert.assertEquals(new Double(12.00),calculator.calculateBi(Calculator.BiOperatorModes.multiply,number));
        Assert.assertEquals(new Double(2.00),calculator.calculateBi(Calculator.BiOperatorModes.divide,number));
        Assert.assertEquals(new Double(3.00),calculator.calculateBi(Calculator.BiOperatorModes.divide,number));
